...
const RegistroIndicadores: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
      indicador_id: '',
      // CORRECCIÓN: Usamos slice(0, 10) para obtener YYYY-MM-DD (Fecha completa)
  ...
  const handleSubmit = async (estado: 'Borrador' | 'Enviado') => {
      ...
      const payload = {
          ...
          periodo: formData.periodo, // CORRECCIÓN: Se envía la fecha exacta seleccionada (día/mes/año)
      ...
      try {
          ...
          // Limpiar solo los campos de datos, mantener fecha e indicador por comodidad
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 mb-8 animate-in zoom-in-95 duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    ...
                    <div className="bg-white border border-red-100 p-3 rounded-lg flex justify-between items-center">
                        ...
                        <span className="text-xs font-black text-red-700">&lt; {selectedInd.umbral_amarillo}%</span>
                    </div>
                </div>
            </div>
         )}
